...
const TemplateBuilderPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const phasesResponse = await axios.get('http://localhost:8000/template/phases');
      setPhases(phasesResponse.data);
      const tasksResponse = await axios.get('http://localhost:8000/template/tasks');
      setTasks(tasksResponse.data);
      const sprintsResponse = await axios.get('http://localhost:8000/template/sprints');
      setSprints(sprintsResponse.data);
      const storiesResponse = await axios.get('http://localhost:8000/template/stories');
